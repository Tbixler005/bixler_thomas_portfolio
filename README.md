...
folder of files; in-progress coursework is described below and will be posted as
it develops.

## Intellectual Humility & Apology Quality
...
argument and hypotheses, operationalized variables, a replicable procedure, and an
a priori analysis plan stating what each outcome would and would not support.
Findings are presented across three group research presentations with structured
written peer review through Peerceptiv. Materials will be added here as the course
progresses.
...
journals into evidence-based recommendations delivered in a team presentation. A
separate Personal Map project integrates three or more organizational-behavior
concepts into a visual, interactive project with a class presentation and written
reflection. Materials will be added here as the course progresses.

📁 [View project files →](organizational-psychology)
...
📄 [Resume](https://github.com/Tbixler005/Tbixler005/blob/main/thomas_bixler_resume.pdf) &nbsp;·&nbsp; 💼 [LinkedIn](https://www.linkedin.com/in/t-bixler/) &nbsp;·&nbsp; ✉️ tbix2005@outlook.com
